...
const PostComponents = ({ post, isLike,setPosts ,posts,onView}) => {
  ...
  return (
    ...
    {post.post_imgs.length > 1 && (index < post.post_imgs.length - 1) && (
      ...
      <BottomContainer>
        ...
        <EmojiInputContainer>
        <AddComments onFocus={() => setOpenEmoji(false)} ref={CommentInputRef} onKeyDown={EnterHandle} type="text" name='comment' placeholder="Add a commentss" />
        <SmileComments>
